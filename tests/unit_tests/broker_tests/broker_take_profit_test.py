...
@pytest.mark.parametrize(
    "market_data, spread", [([(None, 90.0, 95.0, 90.0, 95.0, None)], 2.2)]
)
...
@pytest.mark.parametrize(
    "market_data, spread", [([(None, 90.0, 97.2, 90.0, 97.2, None)], 2.2)]
)
...
@pytest.mark.parametrize(
    "market_data, spread", [([(None, 90.0, 90.0, 85.0, 85.0, None)], 2.2)]
)
...
@pytest.mark.parametrize(
    "market_data, spread", [([(None, 90.0, 90.0, 82.8, 82.8, None)], 2.2)]
)
...
@pytest.mark.parametrize(
    ...
    [
        [
            (None, 100.0, 101.0, 100.0, 101.0, None),
...
def test_long_commission(test_data: Data, test_broker: Broker, test_account: Account):
    open_order = OpenOrder(
        size=1,
        position_type=PositionType.LONG,
        take_profit=90.0,
...
def test_short_commission(test_data: Data, test_broker: Broker, test_account: Account):
    open_order = OpenOrder(
        size=1,
        position_type=PositionType.SHORT,
        take_profit=80.0,
