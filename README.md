...
- matplotlib - for drawing result plots
...
```bash
python3 -m pip install stock-backtesing
```
...
We use [TA-Lib](https://github.com/TA-Lib/ta-lib-python) to calucalte Relative Strength Indicator values. 
